...
Django TestCase, SQLite in-memory test database, unittest.mock
...
As a new user, I want to register an account, so that I can create my own profile in the movie recommendation system.

As a registered user, I want to log in to my account, so that the system can identify me and show my saved information.

As a user, I want to browse the movie list, so that I can view available movies and their basic ratings.

As a user, I want to search for movies by entering keywords, so that I can find specific movies more quickly.

As a user, I want to search for movies by tags or genres, so that I can quickly find movies that match my interests.

As a user, I want to view detailed movie information, so that I can decide whether a movie is suitable for me.

As a user, I want to rate and comment on movies, so that I can record my opinion and provide data for recommendations.

As a user, I want to view my rating history, so that I can check the movies I have rated before.

As a user, I want the system to recommend movies based on similar users and movie similarity, so that I can discover suitable movies more efficiently.

As an administrator, I want to manage movie, genre, rating, and user data in the backend, so that the movie database can remain organised and accurate.
...
Admin Delete Movie Information
...
Django management command file

movie/models.py

Defines movie, genre, user, rating, popular movie, and similarity models

movie/views.py

Handles page logic for index, login, register, search, tag filtering, detail, history, and recommendation pages

movie/forms.py

Defines registration, login, and comment/rating forms

movie/urls.py

Defines URL routes for the movie app

movie/admin.py

Registers movie-related models in the Django admin backend

movie/tests.py

Contains automated tests for Practical 7

movie/test_practical8_mock.py

Contains the Practical 8 mock object login test

practical9_bug_tracking_and_system_testing.md

Contains the Practical 9 bug/error tracking process and Week 10 system testing plan

Movie_recommendation_system/settings.py

Main Django settings file

Movie_recommendation_system/test_settings.py

Test settings using SQLite in-memory database
...
Movie app static resources, including movie data and posters
...
Stores movie genre/type information

Movie

Stores movie information such as name, IMDb ID, duration, genre, release time, introduction, director, writers, and actors

Movie_similarity

Stores similarity relationships between movies

User

Stores custom user account information
...
Stores popular movie records based on rating count
...
Movie genre/tag filtering page
...
Iteration 1 reflection, actual velocity, SRP/DRY check, and completed vs unfinished user stories

practical6_iteration2_planning.md

Iteration 2 planning, burndown chart, velocity usage, backlog update, and completed work

practical7_tdd_testing_plan.md

Practical 7 testing plan, selected user stories, 15 test cases, and automated testing summary

practical8_iteration3_tdd.md

Practical 8 Iteration 3 TDD plan, Iteration 2 reflection, velocity calculation, burndown chart, and mock object framework research

practical8_test_result.png

Evidence screenshot showing 16 automated tests passed

practical9_bug_tracking_and_system_testing.md

Practical 9 bug/error tracking process, bug report template, GitHub Issues tracking, and Week 10 demo system testing plan

practical9_bug_issues_screenshot.png

Evidence showing GitHub bug/improvement issues created for Practical 9

practical9_project_board_screenshot.png

Evidence showing bugs tracked in the GitHub Project Board

practical9_instructor_access.png

Evidence showing instructor repository access invitation
...
#54 [Bug] Movie list pagination may show inconsistent order
...
#55 [Bug] Parent user story status not updated after sub-issues completed

Bug

Iteration 2 project tracking

Medium

Todo

#56 [Improvement] Add clearer error message for invalid login
...
Record bugs, errors, and improvements

GitHub Labels

Mark issue type, priority, and testing status

GitHub Project Board

Track issue progress using Todo, In Progress, Fixed, Verified, and Done

Pull Requests

Review bug fixes before merging

Screenshots

Provide evidence for testing and tracking
...
View repository, project board, issues, and practical evidence
